<template>
  <div>
    <div v-if="detectTypeMainList.length === 0" class="mb-4">
      <button
        class="ml-auto focus:outline-none bg-blue-300 hover:bg-blue-500 flex items-center font-medium px-2 rounded"
      >
        <div>
        ...
        <div class="ml-1">add detect type</div>
      </button>
    </div>
